...
app.config['MAIL_USERNAME'] = 'neha12ch07@gmail.com'  # email
app.config['MAIL_PASSWORD'] = 'MaaPapa*ILU'  # password
...
# setting up database
app.config["SQLALCHEMY_DATABASE_URI"] = 'mysql+mysqlconnector://root:Choubey@#23@localhost:3306/eventweb'  # configure URI
    ...
    if request.method == "GET":  # user loads page
        ...
        if username != None:  # user is logged in
            if hashedPassword != user.password:  # wrong password
                ...
                msg = Message('Event Management Account Details for ' + str(username),
                              sender='neha12ch07@gmail.com@gmail.com',
                              recipients=[email])  # prepare message to be sent to user
                msg.html = '<h1 style="text-align: center;">Hey ' + str(
